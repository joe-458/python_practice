...
def tuichu():
    #点击个人中心
    pyautogui.click(1876,940) 
    pyautogui.click(1876,940) 
    #pyautogui.mouseDown(x=2400, y=132, button='left')
    #pyautogui.mouseUp(x=2560, y=132, button='left')
    #点击设置
    pyautogui.click(1884,106) 
    time.sleep(2)
    #这一步是以防出现类似日历的东西
    pyautogui.click(1532,106) 
    pyautogui.click(1884,106) 
    #退出登录
    pyautogui.click(1724,690)     
    #确定
    pyautogui.click(1793,570) 
    #定位登陆界面输入框
    pyautogui.click(1768,337) 
    #删除电话号
...
def denglu(data):
    ...
    #登录流程
    pyautogui.click(1576,433) 
    pyautogui.dragTo(1919,433,duration=0.7) 
    pyautogui.click(1559,716)
    pyautogui.click(1707,560)
